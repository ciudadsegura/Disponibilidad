<?php
	...
	function crearTabla($result_asr,$result_bgp_eventos,$result_bgp_fin,$rango,$c2,$fechaIni,$fechaFin){
		...
		//	continue;
			...
			switch ($conclusion) {
				...
				echo "<td><a href='disponibilidad_detalles.php?ip=".$ips['ip_man']."&asr=$c2&fechaIni=$fechaIni&fechaFin=$fechaFin'>".$ips['ip_man']."</a></td>";
				echo "<td>".$ips["asr"]."</td>";
				if(count($eventosBGPFin)>0){
	...
	//Consulta las ips
	$query="SELECT * FROM ips_asr where asr like('$c2')
	...
	switch ($c2) {
		case 'C2 CENTRO 8k':
			...
			$result_bgp_fin =consultaMultiplebgpt("cnt_bgp8k",$particion,$result_asr,$fechaFin);
			$result_bgp_eventos =consultaMultiplebgptEventos("cnt_bgp8k",$fechaIni,$fechaFin,$rango);
			break;
		case 'C2 SUR 8k':
			//$c2Sur8k=search($result_asr,'asr','C2 SUR 8k');
			$result_bgp_fin =consultaMultiplebgpt("sur_bgp8k",$particion,$result_asr,$fechaFin);
		...
		case 'C2 NORTE 8k':
			...
			$result_bgp_fin =consultaMultiplebgpt("nte_bgp8k",$particion,$result_asr,$fechaFin);
		...
		case 'C2 ORIENTE 8k':
			...
			$result_bgp_fin =consultaMultiplebgpt("ote_bgp8k",$particion,$result_asr,$fechaFin);
		...
		case 'C2 PONIENTE 8k':
			...
			$result_bgp_fin =consultaMultiplebgpt("pte_bgp8k",$particion,$result_asr,$fechaFin);
		...
		case 'C2 CENTRO 7k':
			...
			$result_bgp_fin =consultaMultiplebgpt("cnt_bgp7k",$particion,$result_asr,$fechaFin);
			$result_bgp_eventos =consultaMultiplebgptEventos("cnt_bgp7k",$fechaIni,$fechaFin,$rango);
			break;
		case 'C2 SUR 7k':
			//$c2Sur7k=search($result_asr,'asr','C2 SUR 7k');
			$result_bgp_fin =consultaMultiplebgpt("sur_bgp7k",$particion,$result_asr,$fechaFin);
		...
		case 'C2 NORTE 7k':
			...
			$result_bgp_fin =consultaMultiplebgpt("nte_bgp7k",$particion,$result_asr,$fechaFin);
		...
		case 'C2 ORIENTE 7k':
			...
			$result_bgp_fin =consultaMultiplebgpt("ote_bgp7k",$particion,$result_asr,$fechaFin);
		...
		case 'C2 PONIENTE 7k':
			...
			$result_bgp_fin =consultaMultiplebgpt("pte_bgp7k",$particion,$result_asr,$fechaFin);
	...
	//Se escribe los encabezados de la tabla 
        ...
        echo "</thead>";
		echo "<tbody>";
		crearTabla($result_asr,$result_bgp_eventos,$result_bgp_fin,$rango,$c2,$fechaIni,$fechaFin);
		echo "</tbody>";
		echo "</table>";
		echo "</div>";
		echo "</div>";
